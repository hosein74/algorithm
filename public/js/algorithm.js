    ...
    case 'algorithm':
        switch (path[3]) {
            case 'animation':
                ...
                $('#mySecondHeader1').text('بخش نمایش الگوریتم')
                break;
            case 'analyze':
                $('#mySecondHeader').text('بخش تحلیل الگوریتم')
                $('#mySecondHeader1').text('بخش تحلیل الگوریتم')
                break;
            case 'help-file':
                $('#mySecondHeader').text('بخش راهنمای فایل')
                $('#mySecondHeader1').text('بخش راهنمای فایل')
                break;
            case 'description':
                $('#mySecondHeader').text('بخش توضیحات الگوریتم')
                $('#mySecondHeader1').text('بخش توضیحات الگوریتم')
                break;
        }
    ...
    case 'compare':
        switch (path[2]) {
            case 'sort':
                ...
                $('#myFirstHeader1').text('(comparing sort algorithms) مقایسه الگوریتم های مرتب سازی');
                setAlogs([
            ...
            case 'matrix-multiple':
                ...
                $('#myFirstHeader1').text('(comparing multiple-matrix algorithms) مقایسه الگوریتم های ضرب ماتریس')
                setAlogs([
            ...
            case 'multiple':
                ...
                $('#myFirstHeader1').text('(comparing multiple algorithms) مقایسه الگوریتم های ضرب معمولی')
                setAlogs([
            ...
            case 'search':
                ...
                $('#myFirstHeader1').text('(comparing graph search algorithms) مقایسه الگوریتم های پیمایش گراف')
                setAlogs([
                    {id:'dfs',name:'اول عمق'},
                    {id:'bfs',name:'اول سطح'}
                ]);
            ...
            case 'mst':
                ...
                $('#myFirstHeader1').text('(comparing minimum spanning tree algorithms) مقایسه الگوریتم های درخت پوشای مینیمال')
                setAlogs([
                    {id:'prim',name:'پریم'},
