...
function *prim(element) {
    ...
    for (var k = 0; k < data.nodes.length - 1; k++) { // Searching for k edges
        ...
        for (var i = 0; i < data.nodes.length; i++) {
            if (visited[i]) {
                for (var j = 0; j < data.links.length; j++) {
                    if(data.links[j].source.index === i && visited[data.links[j].target.index] === false){
                        visitElement(i);
                        visitLink(j);
                        yield "";
                        ...
                        unvisitLink(data.links[j].index);
                        yield "";
                        //minJ = j;
                    }
        ...
        visitLink(minJ);
        visitElement(data.links[minJ].target.index);
        yield "";
        visited[data.links[minJ].target.index] = true;
    }
}
////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////
