...
var edge = data.links.sort((a, b) => Number(a.value) - Number(b.value));
...
for (var i=0;i<edge.length;i++){
    edges[i][0] = edge[i].source.index;
    edges[i][1] = edge[i].target.index;
...
var seq = kruskal(data.nodes[0].id);
//log(enc);
